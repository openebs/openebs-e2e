...
const (
	Registration_Register_FullMethodName   = "/mayastor.v1.Registration/Register"
	Registration_Deregister_FullMethodName = "/mayastor.v1.Registration/Deregister"
)
...
func (c *registrationClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *registrationClient) Deregister(ctx context.Context, in *DeregisterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Registration_Deregister_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Registration_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mayastor.v1.Registration",
