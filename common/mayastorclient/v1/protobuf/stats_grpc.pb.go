...
const (
	StatsRpc_GetPoolIoStats_FullMethodName    = "/mayastor.v1.StatsRpc/GetPoolIoStats"
	StatsRpc_GetNexusIoStats_FullMethodName   = "/mayastor.v1.StatsRpc/GetNexusIoStats"
	StatsRpc_GetReplicaIoStats_FullMethodName = "/mayastor.v1.StatsRpc/GetReplicaIoStats"
	StatsRpc_ResetIoStats_FullMethodName      = "/mayastor.v1.StatsRpc/ResetIoStats"
)
...
type StatsRpcClient interface {
	...
	GetNexusIoStats(ctx context.Context, in *ListStatsOption, opts ...grpc.CallOption) (*NexusIoStatsResponse, error)
	// RPC to get Replica IO stats.
	GetReplicaIoStats(ctx context.Context, in *ListStatsOption, opts ...grpc.CallOption) (*ReplicaIoStatsResponse, error)
...
func (c *statsRpcClient) GetPoolIoStats(ctx context.Context, in *ListStatsOption, opts ...grpc.CallOption) (*PoolIoStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, StatsRpc_GetPoolIoStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsRpcClient) GetNexusIoStats(ctx context.Context, in *ListStatsOption, opts ...grpc.CallOption) (*NexusIoStatsResponse, error) {
	out := new(NexusIoStatsResponse)
	err := c.cc.Invoke(ctx, StatsRpc_GetNexusIoStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsRpcClient) GetReplicaIoStats(ctx context.Context, in *ListStatsOption, opts ...grpc.CallOption) (*ReplicaIoStatsResponse, error) {
	out := new(ReplicaIoStatsResponse)
	err := c.cc.Invoke(ctx, StatsRpc_GetReplicaIoStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statsRpcClient) ResetIoStats(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, StatsRpc_ResetIoStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatsRpcServer interface {
	...
	// RPC to get Nexus IO stats.
	GetNexusIoStats(context.Context, *ListStatsOption) (*NexusIoStatsResponse, error)
	// RPC to get Replica IO stats.
	GetReplicaIoStats(context.Context, *ListStatsOption) (*ReplicaIoStatsResponse, error)
	// RPC to reset Io Stats for all Pool, Replica and Nexus hosted on the node.
...
func (UnimplementedStatsRpcServer) GetNexusIoStats(context.Context, *ListStatsOption) (*NexusIoStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNexusIoStats not implemented")
}
func (UnimplementedStatsRpcServer) GetReplicaIoStats(context.Context, *ListStatsOption) (*ReplicaIoStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReplicaIoStats not implemented")
}
...
func _StatsRpc_GetPoolIoStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatsRpc_GetPoolIoStats_FullMethodName,
	}
...
func _StatsRpc_GetNexusIoStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListStatsOption)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatsRpcServer).GetNexusIoStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatsRpc_GetNexusIoStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsRpcServer).GetNexusIoStats(ctx, req.(*ListStatsOption))
	}
	return interceptor(ctx, in, info, handler)
}

func _StatsRpc_GetReplicaIoStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListStatsOption)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatsRpcServer).GetReplicaIoStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatsRpc_GetReplicaIoStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsRpcServer).GetReplicaIoStats(ctx, req.(*ListStatsOption))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StatsRpc_ResetIoStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatsRpc_ResetIoStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var StatsRpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNexusIoStats",
			Handler:    _StatsRpc_GetNexusIoStats_Handler,
		},
		{
			MethodName: "GetReplicaIoStats",
			Handler:    _StatsRpc_GetReplicaIoStats_Handler,
		},
		{
