...
const (
	PoolRpc_CreatePool_FullMethodName  = "/mayastor.v1.PoolRpc/CreatePool"
	PoolRpc_DestroyPool_FullMethodName = "/mayastor.v1.PoolRpc/DestroyPool"
	PoolRpc_ExportPool_FullMethodName  = "/mayastor.v1.PoolRpc/ExportPool"
	PoolRpc_ImportPool_FullMethodName  = "/mayastor.v1.PoolRpc/ImportPool"
	PoolRpc_ListPools_FullMethodName   = "/mayastor.v1.PoolRpc/ListPools"
	PoolRpc_GrowPool_FullMethodName    = "/mayastor.v1.PoolRpc/GrowPool"
)
...
type PoolRpcClient interface {
	...
	GrowPool(ctx context.Context, in *GrowPoolRequest, opts ...grpc.CallOption) (*GrowPoolResponse, error)
}
...
func (c *poolRpcClient) CreatePool(ctx context.Context, in *CreatePoolRequest, opts ...grpc.CallOption) (*Pool, error) {
	out := new(Pool)
	err := c.cc.Invoke(ctx, PoolRpc_CreatePool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolRpcClient) DestroyPool(ctx context.Context, in *DestroyPoolRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, PoolRpc_DestroyPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolRpcClient) ExportPool(ctx context.Context, in *ExportPoolRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PoolRpc_ExportPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolRpcClient) ImportPool(ctx context.Context, in *ImportPoolRequest, opts ...grpc.CallOption) (*Pool, error) {
	out := new(Pool)
	err := c.cc.Invoke(ctx, PoolRpc_ImportPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolRpcClient) ListPools(ctx context.Context, in *ListPoolOptions, opts ...grpc.CallOption) (*ListPoolsResponse, error) {
	...
	err := c.cc.Invoke(ctx, PoolRpc_ListPools_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poolRpcClient) GrowPool(ctx context.Context, in *GrowPoolRequest, opts ...grpc.CallOption) (*GrowPoolResponse, error) {
	out := new(GrowPoolResponse)
	err := c.cc.Invoke(ctx, PoolRpc_GrowPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PoolRpcServer interface {
	...
	GrowPool(context.Context, *GrowPoolRequest) (*GrowPoolResponse, error)
...
func (UnimplementedPoolRpcServer) GrowPool(context.Context, *GrowPoolRequest) (*GrowPoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GrowPool not implemented")
}
...
func _PoolRpc_CreatePool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolRpc_CreatePool_FullMethodName,
	}
...
func _PoolRpc_DestroyPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolRpc_DestroyPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoolRpc_ExportPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolRpc_ExportPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoolRpc_ImportPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolRpc_ImportPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoolRpc_ListPools_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolRpc_ListPools_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoolRpc_GrowPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GrowPoolRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PoolRpcServer).GrowPool(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoolRpc_GrowPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PoolRpcServer).GrowPool(ctx, req.(*GrowPoolRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PoolRpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GrowPool",
			Handler:    _PoolRpc_GrowPool_Handler,
		},
	},
