...
const (
	ReplicaRpc_CreateReplica_FullMethodName      = "/mayastor.v1.ReplicaRpc/CreateReplica"
	ReplicaRpc_DestroyReplica_FullMethodName     = "/mayastor.v1.ReplicaRpc/DestroyReplica"
	ReplicaRpc_ListReplicas_FullMethodName       = "/mayastor.v1.ReplicaRpc/ListReplicas"
	ReplicaRpc_ShareReplica_FullMethodName       = "/mayastor.v1.ReplicaRpc/ShareReplica"
	ReplicaRpc_UnshareReplica_FullMethodName     = "/mayastor.v1.ReplicaRpc/UnshareReplica"
	ReplicaRpc_ResizeReplica_FullMethodName      = "/mayastor.v1.ReplicaRpc/ResizeReplica"
	ReplicaRpc_SetReplicaEntityId_FullMethodName = "/mayastor.v1.ReplicaRpc/SetReplicaEntityId"
)
...
type ReplicaRpcClient interface {
	...
	SetReplicaEntityId(ctx context.Context, in *SetReplicaEntityIdRequest, opts ...grpc.CallOption) (*Replica, error)
}
...
func (c *replicaRpcClient) CreateReplica(ctx context.Context, in *CreateReplicaRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := c.cc.Invoke(ctx, ReplicaRpc_CreateReplica_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaRpcClient) DestroyReplica(ctx context.Context, in *DestroyReplicaRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ReplicaRpc_DestroyReplica_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaRpcClient) ListReplicas(ctx context.Context, in *ListReplicaOptions, opts ...grpc.CallOption) (*ListReplicasResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReplicaRpc_ListReplicas_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaRpcClient) ShareReplica(ctx context.Context, in *ShareReplicaRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := c.cc.Invoke(ctx, ReplicaRpc_ShareReplica_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaRpcClient) UnshareReplica(ctx context.Context, in *UnshareReplicaRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := c.cc.Invoke(ctx, ReplicaRpc_UnshareReplica_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaRpcClient) ResizeReplica(ctx context.Context, in *ResizeReplicaRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := c.cc.Invoke(ctx, ReplicaRpc_ResizeReplica_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *replicaRpcClient) SetReplicaEntityId(ctx context.Context, in *SetReplicaEntityIdRequest, opts ...grpc.CallOption) (*Replica, error) {
	out := new(Replica)
	err := c.cc.Invoke(ctx, ReplicaRpc_SetReplicaEntityId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReplicaRpcServer interface {
	...
	SetReplicaEntityId(context.Context, *SetReplicaEntityIdRequest) (*Replica, error)
...
func (UnimplementedReplicaRpcServer) SetReplicaEntityId(context.Context, *SetReplicaEntityIdRequest) (*Replica, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetReplicaEntityId not implemented")
}
...
func _ReplicaRpc_CreateReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_CreateReplica_FullMethodName,
	}
...
func _ReplicaRpc_DestroyReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_DestroyReplica_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReplicaRpc_ListReplicas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_ListReplicas_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReplicaRpc_ShareReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_ShareReplica_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReplicaRpc_UnshareReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_UnshareReplica_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReplicaRpc_ResizeReplica_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_ResizeReplica_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReplicaRpc_SetReplicaEntityId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetReplicaEntityIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReplicaRpcServer).SetReplicaEntityId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReplicaRpc_SetReplicaEntityId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicaRpcServer).SetReplicaEntityId(ctx, req.(*SetReplicaEntityIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReplicaRpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetReplicaEntityId",
			Handler:    _ReplicaRpc_SetReplicaEntityId_Handler,
		},
	},
