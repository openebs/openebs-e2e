...
// checks if the AppNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodes{}

// AppNodes Array of app nodes plus the next token for subsequent get requests when using pagination.
type AppNodes struct {
	Entries []AppNode `json:"entries"`
	NextToken *int32 `json:"next_token,omitempty"`
}

type _AppNodes AppNodes
...
func (o AppNodes) MarshalJSON() ([]byte, error) {
...
func (o AppNodes) ToMap() (map[string]interface{}, error) {
...
func (o *AppNodes) UnmarshalJSON(data []byte) (err error) {
	...
	varAppNodes := _AppNodes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppNodes)

	if err != nil {
		return err
	}

	*o = AppNodes(varAppNodes)

	return err
}

type NullableAppNodes struct {
	value *AppNodes
	isSet bool
}

func (v NullableAppNodes) Get() *AppNodes {
	return v.value
}

func (v *NullableAppNodes) Set(val *AppNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodes(val *AppNodes) *NullableAppNodes {
	return &NullableAppNodes{value: val, isSet: true}
}

func (v NullableAppNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
