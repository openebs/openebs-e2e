...
type DiskPoolInterface interface {
	Create(ctxt context.Context, diskpool *v1beta2.DiskPool, opts metav1.CreateOptions) (*v1beta2.DiskPool, error)
	Get(ctxt context.Context, name string, opts metav1.GetOptions) (*v1beta2.DiskPool, error)
	List(ctxt context.Context, opts metav1.ListOptions) (*v1beta2.DiskPoolList, error)
	Update(ctxt context.Context, diskpool *v1beta2.DiskPool, opts metav1.UpdateOptions) (*v1beta2.DiskPool, error)
...
func (c *dspClient) Create(ctxt context.Context, diskpool *v1beta2.DiskPool, opts metav1.CreateOptions) (*v1beta2.DiskPool, error) {
	result := v1beta2.DiskPool{}
	err := c.restClient.
		Post().
...
func (c *dspClient) Get(ctxt context.Context, name string, opts metav1.GetOptions) (*v1beta2.DiskPool, error) {
	result := v1beta2.DiskPool{}
	err := c.restClient.
		Get().
		Namespace(common.NSMayastor()).
...
func (c *dspClient) List(ctxt context.Context, opts metav1.ListOptions) (*v1beta2.DiskPoolList, error) {
	result := v1beta2.DiskPoolList{}
	err := c.restClient.
		Get().
		Namespace(common.NSMayastor()).
		Resource(e2e_config.GetConfig().Product.CrdPoolsResourceName).
...
func (c *dspClient) Update(ctxt context.Context, diskpool *v1beta2.DiskPool, opts metav1.UpdateOptions) (*v1beta2.DiskPool, error) {
	result := v1beta2.DiskPool{}
	err := c.restClient.
		Put().
		Namespace(common.NSMayastor()).
