...
func (ifc v1alpha1ExtIfc) CreateMsPoolWithClusterSize(poolName string, node string, disks []string, clusterSize string) (crtypes.DiskPool, error) {
	panic(fmt.Errorf("not implemented cluster size pool in v1alpha1Ext"))
}

func (p v1alpha1ExtDSP) SetClusterSize(clusterSize string) (crtypes.DiskPool, error) {
	panic(fmt.Errorf("not implemented cluster size pool in v1alpha1Ext"))
}
...
func (ifc v1alpha1ExtIfc) CreateMsPoolWithEncryptionAndMaxSize(poolName string, node string, disks []string, encryptionSecretName string, maxSize string, clusterSize string) (crtypes.DiskPool, error) {
	panic(fmt.Errorf("encryption with max size and cluster size not supported in v1alpha1Ext"))
}
...
func (p v1alpha1ExtDSP) GetPoolErrorCount() uint64 {
	panic(fmt.Errorf("pool error count not supported in v1alpha1Ext"))
}
...
func (p v1alpha1ExtDSP) GetIOStallValue() bool {
	panic(fmt.Errorf("i/o stall value not supported in v1alpha1Ext"))
}

func (p v1alpha1ExtDSP) GetAlerts() disk_failures.DiskPoolAlerts {
	panic(fmt.Errorf("pool alerts not supported in v1alpha1Ext"))
}
